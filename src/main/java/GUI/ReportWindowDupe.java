...
class ReportWindowDupe extends JFrame{
    /*FIELD                                                                                     */
    /*==========================================================================================*/
    JTextArea ta;
    ...
    /*CONSTRUCTOR                                                                               */
    /*==========================================================================================*/
    public ReportWindowDupe(File file) {
        String currMonth = "Current Month";

        String currCheck = Algorithm.monthName(file);

        if(!currCheck.isEmpty()){currMonth = currCheck;}

        setTitle("REPORT - DUPLICATE DETECTION");
        ...
        Algorithm dupes = new Algorithm(file, outStream);
        dupes.checkDupes();

        JLabel reportHeader = new JLabel();
        reportHeader.setText("Duplicate Report: " + currMonth);
